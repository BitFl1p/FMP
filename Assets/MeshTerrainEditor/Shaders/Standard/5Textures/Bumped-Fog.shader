Shader "MTE/Standard/5 Textures/Bumped/Fog"
{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, half smoothness[5], out half4 splat_control, out half4 splat_control_extra, out half weight, out fixed4 mixedDiffuse, inout float3 mixedNormal)
		{
			...
			mixedDiffuse += splat_control_extra.r * tex2D(_Splat4, IN.tc_Splat23.zw) * half4(1.0, 1.0, 1.0, smoothness[4]);
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			MTE_SplatmapMix(IN, smoothness, splat_control, splat_control_extra, weight,
