Shader "MTE/Standard/6 Textures/Bumped"
{
	Properties
	{
	...
	CGINCLUDE
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			half4 defaultSmoothness1 = half4(_Smoothness4, _Smoothness5, 0, 0);
			...
			o.Metallic = dot(splat_control, half4(_Metallic0, _Metallic1, _Metallic2, _Metallic3)) + dot(splat_control_extra.rg, half2(_Metallic4, _Metallic5));
		}
	ENDCG
	...
	Fallback "MTE/Standard/6 Textures/Diffuse"
